...
/
[`render_grid()`](https://r-vellum.github.io/vellum/reference/as_vellum.md)
when you already have grid, ggplot2, or lattice output and want vellum’s
...
Interop reproduces the *pixels* of a grid scene, but a grammar built
directly on vellum is what carries the per-element identity that
interactivity needs.
