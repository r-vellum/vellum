...
#> • compile 0.018 s (R -> Rust replay, incl. text shaping)
#> • raster 0.161 s (drawing)
#> 
#> Slowest marks (raster time):
#> • circle points 20000 elem 0.1028 s 76.7%
#> • segments edges 2000 elem 0.0290 s 21.6%
#> • text labels 200 elem 0.0022 s 1.7%
```
