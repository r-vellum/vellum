...
Each is an immutable value object; building one draws nothing on its
own.
...
[`draw()`](https://schochastics.github.io/vellum/reference/vl_scene.md)
adds a grob at the current level, and
...
[`vignette("scene-and-paint")`](https://schochastics.github.io/vellum/articles/scene-and-paint.md)
...
- [`vignette("coming-from-grid")`](https://schochastics.github.io/vellum/articles/coming-from-grid.md):
