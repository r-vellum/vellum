...
A viewport may define a row/column `grid_layout()`; child viewports are
...
- clip:
  ...
  rectangle, or a
  [`polygon_grob()`](https://schochastics.github.io/vellum/reference/grob.md)/[`path_grob()`](https://schochastics.github.io/vellum/reference/grob.md)
...
- cache:
  ...
  **unchanged**, the cached pixels are composited instead of re-drawing
  ...
  Raster/[`display()`](https://schochastics.github.io/vellum/reference/display.md)
