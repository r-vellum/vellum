...
[`grobwidth()`](https://schochastics.github.io/vellum/reference/grobwidth.md)/[`grobheight()`](https://schochastics.github.io/vellum/reference/grobwidth.md)).
...
element), so a `quill` mark can carry a per-datum rich label.
