...
#
# Linear and radial gradients used as `gpar(fill = ...)`. Gradient geometry is
...
s <- vl_scene(width = 7, height = 4, dpi = 150, bg = "white") |>
  ...
  draw(circle_grob(x = 0.78, y = 0.72, r = 0.16, gp = gpar(
    col = NA,
  ...
  draw(rect_grob(x = 0.20, y = 0.28, width = 0.12, height = 0.46, gp = gpar(
    col = NA,
    fill = linear_gradient(c("#10202a", "#3d5a6c"), extend = "reflect",
                           x1 = 0.14, y1 = 0.5, x2 = 0.26, y2 = 0.5)
  ))) |>
  draw(rect_grob(x = 0.36, y = 0.36, width = 0.12, height = 0.62, gp = gpar(
    col = NA,
    fill = linear_gradient(c("#102a22", "#3d6c58"), extend = "reflect",
                           x1 = 0.30, y1 = 0.5, x2 = 0.42, y2 = 0.5)
  ))) |>
  draw(rect_grob(x = 0.52, y = 0.24, width = 0.12, height = 0.38, gp = gpar(
    col = NA,
  ...
  draw(text_grob("vellum gradients", x = 0.5, y = 0.06,
                 gp = gpar(col = "white", fontface = "bold", fontsize = 16)))
