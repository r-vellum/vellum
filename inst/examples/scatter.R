...
s <- s |>
  draw(text_grob(
    ...
    y = 1.0,
    just = c("centre", "top"),
    gp = vl_gpar(fontface = "bold", fontsize = 16)
  )) |>
  draw(text_grob(
    "Speed (mph)",
    x = 0.5,
