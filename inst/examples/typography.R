...
scene <- vl_scene(7, 4.4, dpi = 150, bg = "white") |>
  ...
  draw(text_grob(
    "halo_width is in points, like fontsize -- about an eighth of it reads well",
    x = 0.97,
    y = 0.06,
    just = c("right", "bottom"),
    gp = vl_gpar(
  ...
  draw(text_grob(
    paste(
      "Common tags: tnum (tabular figures, so axis labels stop jittering),",
