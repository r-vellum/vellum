...
underlies ggplot2. It is not a plotting package itself; a Vega-style grammar
package on top is in design.
...
- **A retained scene graph, not immediate-mode drawing.** Because the scene is
  ...
  **hit-testing** (`hit_test()` picks the topmost grob under a point), a
