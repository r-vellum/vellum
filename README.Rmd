...
[quill](https://github.com/schochastics/quill) grammar of graphics is built on
top of it.
...
or facets) — that is [quill](https://github.com/schochastics/quill), which
...
- **[gloss](https://github.com/schochastics/gloss)** — the gloss: client-side
  interactive HTML widgets for vellum scenes and quill plots.
